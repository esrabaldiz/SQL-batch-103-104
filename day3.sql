...
INSERT INTO ogrenciler3 VALUES(128, 'ESRA CAGAN', 'Ali', 100);
...
INSERT INTO taleb VALUES(125, 'Kemal Yasa', 'Hasan',85);
...
DELETE FROM  not1 WHERE talebe_id='126'
/*
...
where marka_isim IN (SELECT isyeri from calisanlar2 where sehir='Ankara');--odevdi yaptim
--AGGREGATE METHOD
